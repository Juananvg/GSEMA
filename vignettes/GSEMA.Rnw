...
\author[1,2]{Pablo Jurado-Bascón}
...
\begin{itemize}
    \item study1Ex, study2Ex, study3Ex: threee expression matrices.
    \item study1Pheno, study2Pheno, study3Pheno: three phenodata objects.
