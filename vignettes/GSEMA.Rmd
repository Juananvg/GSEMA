...
* study1Ex, study2Ex, study3Ex: threee expression matrices.
* study1Pheno, study2Pheno, study3Pheno: three phenodata objects.
...
* proportionData: a number between 0 and 1 that indicates the minimum proportion of datasets in which a pathway must be contained to be included.
